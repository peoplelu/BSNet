...
parser.add_argument(
    "--data_dir", type=str, default="/ssd/Dataset/s3dis/gapro/Stanford3dDataset_v1.2_Aligned_Version/", help="Path to the original data"
)
...
def preprocess_s3dis(data_dir):
    ...
    for scene_name in scene_list:
        area = scene_name.split(".")[0]
        name = scene_name.split(".")[1]
        save_dir = "/ssd/Dataset/s3dis/gapro/preprocess"
