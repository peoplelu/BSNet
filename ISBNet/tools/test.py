...
from isbnet.evaluation import PointWiseEval, S3DISEval
from isbnet.evaluation.instance_eval import ScanNetEval
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(dataloader):
            ...
            if cfg.model.semantic_only:
                ...
                loaded_data = torch.load(dataset.filenames[i])
                _, _, semantic_label, instance_label = loaded_data
